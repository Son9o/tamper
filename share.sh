...
ShareUserResponse=$(curl --compressed -X POST "https://api.gotinder.com/user/${1}/share" -H "User-Agent: ${UserAgent}" -H "app-version: ${AppVersion}" -H "os-version: ${OSversion}" -H "platform: android" -H "Content-Type: application/json" -H "Host: api.gotinder.com" -H "Connection: Keep-Alive" -H "Accept-Encoding: gzip" -H "Accept-Language: en" -H "X-Auth-Token: ${XAuthToken}")
echo ${ShareUserResponse}
